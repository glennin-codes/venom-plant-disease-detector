  ...
  const toggleMenu = ():void => {
    ...
    return(
      ...
      <div className={`md:hidden `}>
        <div
          id="menu"
          className={`absolute  font-Poppins flex-col items-center ${isMenuOpen ? 'flex' : 'hidden'} self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md`}
        >
          <a href="#">Pricing</a>
          <a href="#">Product</a>
          <a href="#">About Us</a>
